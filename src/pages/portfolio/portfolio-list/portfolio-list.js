 ...
 */
var PortfolioListPage = /** @class */ (function () {
    function PortfolioListPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    PortfolioListPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad PortfolioListPage');
    };
    PortfolioListPage = __decorate([
        IonicPage(),
        Component({
